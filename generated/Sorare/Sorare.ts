...
export class Sorare__getCardResult {
  value0: BigInt;
  value1: i32;
  value2: BigInt;
  value3: i32;
...
export class Sorare__getClubResult {
  value0: string;
  value1: string;
  value2: string;
  value3: i32;
...
export class Sorare__getPlayerResult {
  value0: string;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class Sorare extends ethereum.SmartContract {
  static bind(address: Address): Sorare {
    return new Sorare("Sorare", address);
  }
  ...
  getCard(tokenId: BigInt): Sorare__getCardResult {
    let result = super.call(
      "getCard",
    ...
    return new Sorare__getCardResult(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_getCard(tokenId: BigInt): ethereum.CallResult<Sorare__getCardResult> {
    let result = super.tryCall(
      "getCard",
      "getCard(uint256):(uint256,uint16,uint256,uint16,bytes,uint16)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
  ...
  getClub(clubId: i32): Sorare__getClubResult {
    let result = super.call(
      "getClub",
    ...
    return new Sorare__getClubResult(
      result[0].toString(),
      result[1].toString(),
      result[2].toString(),
      result[3].toI32()
  ...
  try_getClub(clubId: i32): ethereum.CallResult<Sorare__getClubResult> {
    let result = super.tryCall(
      "getClub",
      "getClub(uint16):(string,string,string,uint16)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(clubId))]
  ...
  getPlayer(playerId: BigInt): Sorare__getPlayerResult {
    let result = super.call(
      "getPlayer",
    ...
    return new Sorare__getPlayerResult(
      result[0].toString(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32()
  ...
  try_getPlayer(
    playerId: BigInt
  ): ethereum.CallResult<Sorare__getPlayerResult> {
    let result = super.tryCall(
      "getPlayer",
      "getPlayer(uint256):(string,uint16,uint8,uint8)",
      [ethereum.Value.fromUnsignedBigInt(playerId)]
